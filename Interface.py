...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboMethods.setItemText(0, _translate("MainWindow", "Não-Supervisionado (MeanShift)"))
        ...
        self.n_clusters_label.setText(_translate("MainWindow", "Nº de indivíduos (k-means)"))
    ...
    def teste1(self):
        ...
        metodo_escolhido = self.comboMethods.currentText()
        print(metodo_escolhido)
        
        num_clusters = int(self.lineEdit_n_clusters.text())
        print(num_clusters)
        
        if metodo_escolhido == "Não-Supervisionado (MeanShift)":
            cls.cluster(ultimo_encoding, endereco_dataset, pasta_resultado_atual)      
        else:
            km.cluster(ultimo_encoding, endereco_dataset, pasta_resultado_atual, num_clusters)
